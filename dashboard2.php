...
$query = "SELECT * FROM users where empstatus not like 'deleted' AND position='Training' ORDER BY id DESC";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a href="trans2.php">View Pending Transactions</a>
      <a href="viewapprove2.php">View Approve Transactions</a>
