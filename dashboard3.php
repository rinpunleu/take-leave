...
$query = "SELECT * FROM users where empstatus not like 'deleted' AND position='treatment' ORDER BY id DESC";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="active" href="dashboard3.php">Home</a>
      <a href="trans3.php">View Pending Transactions</a>
      <a href="viewapprove3.php">View Approve Transactions</a>
