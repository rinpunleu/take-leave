...
if(!$_SESSION['id'] and $_SESSION['position'] != $treatment){header('Location:index.php');}
    $logged=($_SESSION['id']);
...
$query = "SELECT * FROM leave_trans 
		...
		WHERE status !='$stat1' and position='Treatment' and status !='$stat2' ORDER BY leave_start DESC";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="dashboard3.php">Employee Management System</a>
    </div>
    	 
      <a  href="dashboard3.php">Home</a>
      <a  class='active' href="trans3.php">View Pending Transactions</a>
      <a href="viewapprove3.php">View Approved Transactions</a>
...
<div class="table100 ver3 m-b-110">
	...
	//while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td class='cell100 column5'> <form method='POST' action='results3.php'>
