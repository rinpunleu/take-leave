...
$query = "SELECT * FROM users where empstatus not like 'deleted' AND position='TreatmentUnit' or position='TrainingUnit' or position='ResearchUnit'  ORDER BY id DESC";
